      ...
      <div class="pt-3 w-4/12 pl-3 pr-3 border hidden" ref="editProductElement">
        ...
        <ul class="mt-3" style="font-size: 13px">
            ...
            <li class="py-1">
                ...
                <input type="text" class="border rounded-md p-2 block shadow w-full" :value="singleProduct ? singleProduct.title : ''"  />
            </li>
            <li class="py-1">
                <label class="text-tiny">Price </label>
                <input type="text" class="border rounded-md p-2 block w-full shadow" :value="singleProduct ? singleProduct.price : ''" />
            </li>
            <li class="py-1">
                <label class="text-tiny">In stock </label>
                <input type="number" class="border rounded-md p-2 block w-full shadow" :value="singleProduct ? singleProduct.stock : ''" />
            </li>
            <li class="py-1">
